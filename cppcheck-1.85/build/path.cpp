...
bool Path::isC(const std::string &path)
{
    ...
    return extension == MatchCompiler::makeConstString(".c") ||
           extension == MatchCompiler::makeConstString(".cl");
}

bool Path::isCPP(const std::string &path)
{
    const std::string extension = getFilenameExtensionInLowerCase(path);
    return extension == MatchCompiler::makeConstString(".cpp") ||
           extension == MatchCompiler::makeConstString(".cxx") ||
           extension == MatchCompiler::makeConstString(".cc") ||
           extension == MatchCompiler::makeConstString(".c++") ||
           extension == MatchCompiler::makeConstString(".hpp") ||
           extension == MatchCompiler::makeConstString(".hxx") ||
           extension == MatchCompiler::makeConstString(".hh") ||
           extension == MatchCompiler::makeConstString(".tpp") ||
           extension == MatchCompiler::makeConstString(".txx") ||
           getFilenameExtension(path) == MatchCompiler::makeConstString(".C"); // In unix, ".C" is considered C++ file
}
